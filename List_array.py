...
class List:
    ...
    def __getitem__(self, i):
        ...
        value = deepcopy(self._values[i-1])
        return value
    ...
    def clean(self):
        ...
        while i<len(self._values):
            if self._values[i] not in em_li:
                em_li.append(self._values[i])
            else:
                self._values.pop(i)
                i-=1
            i+=1
    ...
    def insert(self, i, value):
        ...
        -------------------------------------------------------
        """
        self._values=self._values[0:i]+value+self._values[i+1:]
    ...
    def __eq__(self, target):
        ...
        """
        a=len(self._values)
        b=len(target._values)
        i=0
        res=True
        if a==b:
            while i<a and res==True:
    ...
    def remove(self, key):
        ...
        i = self._linear_search(key)
        value=self._values[i]
        self._values=self._values[0:i]+self._values[i+1:]
    ...
    def split(self):
        ...
        if n%2==1:
            ...
            target1._rear=curr
            target1._count+=int(n/2+0.5)
            target2._front=curr._next
            target2._rear=self._rear
            target2._count=len(self)-target1._count
            curr._next=None
        else:
            curr=self._front
            z=0
